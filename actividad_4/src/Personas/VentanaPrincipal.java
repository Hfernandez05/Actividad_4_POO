...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	public VentanaPrincipal(){  //constructor de la clase VentanaPrincipal
	...
	public void actionPerformed(ActionEvent evento) {
		...
		if (evento.getSource() == eliminar) { /* Si se pulsa el botón eliminar */
			...
			/* Se invoca el método eliminarNombre que elimina el lemento seleccionado */
	...
	private void añadirPersona() {
		...
		Persona p = new Persona(campoNombre.getText(),campoApellidos.getText(),campoTelefono.getText(), campoDireccion.getText());lista.añadirPersona(p); /* Se añade una persona al vector de personas */
